...
public class Laser : MonoBehaviour
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return laser != null &&
               base.Equals(obj) &&
               EqualityComparer<Vector3>.Default.Equals(positionLaser, laser.positionLaser);
    }

    public override int GetHashCode()
    {
        var hashCode = -1927369361;
        hashCode = hashCode * -1521134295 + base.GetHashCode();
        hashCode = hashCode * -1521134295 + EqualityComparer<Vector3>.Default.GetHashCode(positionLaser);
        return hashCode;
    }
}
